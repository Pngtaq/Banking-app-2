export default function UserAccountDetails() {
  return (
    <div className="bg-gray-900 w-full grid-cols-2 grid gap-4 px-26 p-10">
      ...
      <div className="font-medium  col-span-2 row-span-3  bg-gray-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 border border-gray-100 flex flex-col-reverse gap-2 justify-end">
        <div>
          <p>
