...
export default function UserAccountDetails({ children }) {
  return (
    <div className="bg-gray-900 w-full grid-cols-2 grid gap-4 px-10">
      <div className=" bg-gray-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 border border-gray-100 text-4xl text-center flex flex-col justify-center items-center col-span-2  h-10 m-auto px-5">
        <h1 className="text-sm text-emerald-500">Transaction</h1>
      </div>
      ...
      <div className="font-medium  col-span-2 bg-gray-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-90 border border-gray-100 h-50 py-2 px-4 overflow-y-auto">
        <div className="">
          <Outlet />
        </div>
      </div>
